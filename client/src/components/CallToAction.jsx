  ...
  return (
    <div className="flex flex-col sm:flex-row p-3 text-sm font-serif border rounded-bl-3xl rounded-tr-3xl shadow-sm">
      <div className="sm:border-r p-3 flex flex-col gap-3 justify-around pr-6 flex-[2]">
        ...
        <p>
          Subscribe to my monthly newsletter for a roundup of my latest blog
          posts, insights on my tech learning journey, reflections on mental
          health, and practical life tips I've discovered along the way.
        </p>
        <form className="flex flex-col gap-3">
          <input type="email" placeholder="Email address" />
          <Button color="dark" size="sm" className="font-sans">
            SUBSCRIBE
          </Button>
        </form>
      </div>
      <div className="flex flex-col p-3 gap-3 justify-between ml-3 flex-1">
        ...
        ></img>
        <p>
          Jasmine Wu is an aspiring software engineer currently focusing on
